...
<div class="container py-5 mb-lg-3">
    <div class="row justify-content-center pt-lg-4 text-center">
        <div class="col-lg-7 col-md-8 col-sm-9">
            <img class="d-block mx-auto mb-5" src="{{ asset('public/img/3.png') }}" width="340" />
    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-10">
            <div class="row">
                    ...
                    <a class="card h-100 border-0 shadow-sm" href="#">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h5 class="fs-sm mb-0">Trung tam & tin tuc</h5>
                ...
                <a class="btn btn-warning mt-3 me-3" style="width: 25%; text-align: center; margin: 295px" href="{{route('frontend.lichsudonhang')}}">
                    <i class="ci-hourglass-split me-2"></i>Lịch sử mua hàng
                </a>
